...
<div class="container">
    ...
    <h1 class="title">DOUBLE TREE BY HILTON HOTEL</h1>
    ...
    $otel_resim_sql = "SELECT resim_yolu FROM tbl_resim WHERE otel_id = 4";
    $oda_resim_sql = "SELECT resim_yolu FROM tbl_oda_tipi_resim WHERE otel_id = 4";
    $oda_bilgi_sql = "SELECT oda_tipi_isim, oda_tipi_fiyat FROM tbl_oda_tipi_isim_fiyat WHERE otel_id = 4";
